    ...
    <form method="POST" action="{{ route('vendors.update', $vendor->id) }}" enctype="multipart/form-data" class="grid grid-cols-1 md:grid-cols-2 gap-5">
        ...
        <div>
            ...
            @if($vendor->main_photo)
                <img src="{{ asset('storage/'.$vendor->main_photo) }}" class="w-20 h-20 mt-2 rounded object-cover">
            @endif
        </div>
        ...
        <div>
            ...
            @if($vendor->id_front)
                <img src="{{ asset('storage/'.$vendor->id_front) }}" class="w-20 h-20 mt-2 rounded object-cover">
            @endif
        </div>
        ...
        <div>
            ...
            @if($vendor->id_back)
                <img src="{{ asset('storage/'.$vendor->id_back) }}" class="w-20 h-20 mt-2 rounded object-cover">
            @endif
        </div>
        ...
        <div>
            ...
            @if($vendor->kitchen_photo_1)
                <img src="{{ asset('storage/'.$vendor->kitchen_photo_1) }}" class="w-20 h-20 mt-2 rounded object-cover">
            @endif
        </div>
        ...
        <div>
            ...
            @if($vendor->kitchen_photo_2)
                <img src="{{ asset('storage/'.$vendor->kitchen_photo_2) }}" class="w-20 h-20 mt-2 rounded object-cover">
            @endif
        </div>
        ...
        <div>
            ...
            @if($vendor->kitchen_photo_3)
                <img src="{{ asset('storage/'.$vendor->kitchen_photo_3) }}" class="w-20 h-20 mt-2 rounded object-cover">
            @endif
        </div>
