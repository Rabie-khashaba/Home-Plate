...
<html lang="en" dir="ltr">
    <head>
        ...
        <link rel="icon" type="image/x-icon" href="{{ asset('assets/images/Fav.webp') }}" />
                        ...
                        <div class="mb-6 grid grid-cols-1 gap-6 text-white sm:grid-cols-2 xl:grid-cols-4">
                                ...
                                <div class="panel bg-gradient-to-r from-cyan-500 to-cyan-400">
                                    ...
                                    <div class="mt-5 flex items-center">
                                        <div class="text-3xl font-bold ltr:mr-3 rtl:ml-3">{{ number_format($usersCount) }}</div>
                                    </div>
                                    <div class="mt-5 flex items-center font-semibold">
                                        ...
                                        Last Week {{ number_format($usersLastWeek) }}
                                    </div>
                                </div>
                                ...
                                <div class="panel bg-gradient-to-r from-violet-500 to-violet-400">
                                    <div class="flex justify-between">
                                        <div class="text-md font-semibold ltr:mr-1 rtl:ml-1">Vendors</div>
                                        <div x-data="dropdown" @click.outside="open = false" class="dropdown">
                                            <a href="javascript:;" @click="toggle">
                                                <svg
                                                    width="24"
                                    ...
                                    <div class="mt-5 flex items-center">
                                        <div class="text-3xl font-bold ltr:mr-3 rtl:ml-3">{{ number_format($vendorsCount) }}</div>
                                    </div>
                                    <div class="mt-5 flex items-center font-semibold">
                                        <svg
                                            width="24"
                                        ...
                                        Last Week {{ number_format($vendorsLastWeek) }}
                                    </div>
                                </div>
                                ...
                                <div class="panel bg-gradient-to-r from-blue-500 to-blue-400">
                                    <div class="flex justify-between">
                                        <div class="text-md font-semibold ltr:mr-1 rtl:ml-1">Delivery</div>
                                        <div x-data="dropdown" @click.outside="open = false" class="dropdown">
                                            <a href="javascript:;" @click="toggle">
                                                <svg
                                                    width="24"
                                    ...
                                    <div class="mt-5 flex items-center">
                                        <div class="text-3xl font-bold ltr:mr-3 rtl:ml-3">{{ number_format($deliveriesCount) }}</div>
                                    </div>
                                    <div class="mt-5 flex items-center font-semibold">
                                        <svg
                                            width="24"
                                        ...
                                        Last Week {{ number_format($deliveriesLastWeek) }}
                                    </div>
                                </div>
                                ...
                                <div class="panel bg-gradient-to-r from-fuchsia-500 to-fuchsia-400">
                                    ...
                                    <div class="mt-5 flex items-center">
                                        <div class="text-3xl font-bold ltr:mr-3 rtl:ml-3">{{ number_format($ordersCount) }}</div>
                                    </div>
                                    <div class="mt-5 flex items-center font-semibold">
                                        <svg
                                            width="24"
                                        ...
                                        Last Week {{ number_format($ordersLastWeek) }}
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="mb-6 grid gap-6 xl:grid-cols-3">
                                <div class="panel h-full xl:col-span-2">
                                    ...
                                    <p class="text-lg dark:text-white-light/90">Total Orders <span class="ml-2 text-primary">{{ number_format($ordersCount) }}</span></p>
                                ...
                                <div class="panel h-full">
                                    <div class="mb-5 flex items-center dark:text-white-light">
                                        <h5 class="text-lg font-semibold">Top vendors</h5>
                                        <div x-data="dropdown" @click.outside="open = false" class="dropdown ltr:ml-auto rtl:mr-auto">
                                            <a href="javascript:;" @click="toggle">
                                                <svg
                                                    class="h-5 w-5 text-black/70 hover:!text-primary dark:text-white/70"
                                    ...
                                    <div class="space-y-9">
                                        @php
                                            $vendorStyles = [
                                                ['bg' => 'secondary', 'gradient' => 'from-[#7579ff] to-[#b224ef]'],
                                                ['bg' => 'success', 'gradient' => 'from-[#3cba92] to-[#0ba360]'],
                                                ['bg' => 'warning', 'gradient' => 'from-[#f09819] to-[#ff5858]'],
                                            ];
                                        @endphp
                                        @forelse($topVendors as $index => $vendor)
                                            @php
                                                $style = $vendorStyles[$index % count($vendorStyles)];
                                                $percent = round(($vendor->orders_count / $maxVendorOrders) * 100);
                                            @endphp
                                            <div class="flex items-center">
                                                <div class="h-9 w-9 ltr:mr-3 rtl:ml-3">
                                                    <div
                                                        class="grid h-9 w-9 place-content-center rounded-full bg-{{ $style['bg'] }}-light text-{{ $style['bg'] }} dark:bg-{{ $style['bg'] }} dark:text-{{ $style['bg'] }}-light"
                                                    >
                                                ...
                                                <div class="flex-1">
                                                    <div class="mb-2 flex font-semibold text-white-dark">
                                                        <h6>{{ $vendor->restaurant_name ?: $vendor->full_name }}</h6>
                                                        <p class="ltr:ml-auto rtl:mr-auto">{{ number_format($vendor->orders_count) }}</p>
                                                    </div>
                                                    <div class="h-2 w-full rounded-full bg-dark-light shadow dark:bg-[#1b2e4b]">
                                                        <div class="h-full rounded-full bg-gradient-to-r {{ $style['gradient'] }}" style="width: {{ $percent }}%"></div>
                                                    </div>
                                                </div>
                                            </div>
                                        @empty
                                            <div class="text-sm text-white-dark">No vendors yet.</div>
                                        @endforelse
                                    </div>
                                </div>
